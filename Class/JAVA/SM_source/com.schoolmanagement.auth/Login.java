...
public class Login {
	...
	public static void showMenu() {
		...
		}else if(menuSelect.equals("2") && (Auth.level == 1 || Auth.level == 3) ){
			//평가하기
		}else if(menuSelect.equals("3") && (Auth.level == 1 || Auth.level == 2) ){
			//게시판 관리
		}else if(menuSelect.equals("4") && Auth.level == 2 ){
			//성적관리
		}else if(menuSelect.equals("5") && (Auth.level == 2 || Auth.level == 3) ){
			//ca(개발) 활동
		}
